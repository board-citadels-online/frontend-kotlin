...
@JsModule("axios")
external fun <T> axios(config: AxiosConfigSettings? = definedExternally):Promise<AxiosResponse<T>>

@JsModule("axios")
external fun <T> axios(url: String, config: AxiosConfigSettings? = definedExternally):Promise<AxiosResponse<T>>
